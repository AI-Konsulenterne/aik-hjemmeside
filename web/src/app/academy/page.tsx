  ...
  return (
    <>
            ...
            <FadeIn>
              <div>
                ...
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold tracking-heading text-gray-900 leading-[1.04] mt-4 text-balance">
                  I betaler allerede for AI.{" "}
                  <span className="text-primary">Nu skal jeres folk bruge det.</span>
                </h1>
                ...
                <div className="flex items-center gap-3.5 mt-7 text-sm text-gray-500">
                  <span className="w-7 h-px bg-gray-300" />
                  Skræddersyet til ledere og teams · Dansk · Online &amp; on-site
                </div>
              </div>
            </FadeIn>
      ...
      <div className="border-y border-gray-200 bg-gray-50 py-7">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between gap-8 flex-wrap">
          <span className="text-[13px] font-semibold tracking-[0.14em] uppercase text-gray-500">
            &apos;ai i øjenhøjde&apos;
          </span>
          <div className="flex gap-x-14 gap-y-4 flex-wrap">
            {[
              ["4", "moduler, bygget til arbejdet"],
              ["3-7", "min. pr. video"],
              ["100%", "på dansk"],
            ].map(([n, l]) => (
              <div key={l}>
                <div className="text-[32px] font-bold tracking-tight text-gray-900">
                  {n}
                </div>
      ...
      <section id="curriculum" className="py-[clamp(4rem,10vw,7rem)] scroll-mt-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <CourseCard
                ...
                cover={
                  <CourseCover
                    variant="dark"
                    word="ChatGPT"
                    glyph={glyphTile("orange", <ChatIcon />)}
                    motif={
                      <svg
                        className="absolute inset-0 w-full h-full"
                        viewBox="0 0 320 180"
              ...
              <CourseCard
                ...
                cover={
                  <CourseCover
                    variant="tint"
                    word="Claude"
                    glyph={glyphTile("orange", <SparkleIcon />)}
                    motif={
                      <svg
                        className="absolute inset-0 w-full h-full"
                        viewBox="0 0 320 180"
          ...
          <div className="flex items-center gap-3.5 mt-7 text-[15px] text-gray-500">
            ...
            Usikker på hvor I skal starte? Book et opkald, så finder vi det rette
            forløb sammen.
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-14 items-start mt-14">
            ...
            <FadeIn delay={120}>
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 text-white p-11">
                ...
                <div className="relative mt-6 rounded-2xl border-[1.5px] border-dashed border-gray-700 px-6 py-5 text-[15px] leading-relaxed text-gray-400 italic">
                  [Plads til rigtigt bevis: antal hold/virksomheder I har
                  undervist, brancher, eller 1-2 citater fra deltagere med navn
                  og titel.]
                </div>
              </div>
            </FadeIn>
          ...
          <FadeIn>
            <p className="mt-10 max-w-[900px] border-l-[3px] border-primary bg-primary/10 rounded-r-2xl px-7 py-5 text-[19px] leading-snug text-gray-900 font-medium">
              ...
              skal bare have nogle opgaver, der tager for lang tid.
            </p>
          </FadeIn>
        </div>
      </section>
